...
- [Hardware Platform](../02_hardware_platforms/README.md) — physical board, memory map
- [Core Architecture](../07_fpga_cores_architecture/README.md) — how cores use this framework
