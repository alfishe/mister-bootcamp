...
- [Framework — hps_io.sv](../02_framework/hps_io_module.md) — UIO opcodes for input events
- [References — UIO Commands](../15_references/uio_command_reference.md) — joystick/keyboard/mouse opcodes
