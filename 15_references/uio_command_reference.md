[← References Index](README.md) · [↑ Knowledge Base](../README.md)

# UIO Command Reference

All HPS→FPGA communication for peripheral events uses a command-based protocol
over the [SPI-over-GPO bus](../02_framework/spi_protocol.md). Each transaction starts with a **command opcode**
...
The HPS-side sender is [`user_io.cpp`](https://github.com/MiSTer-devel/Main_MiSTer/blob/master/user_io.cpp) / [`spi.cpp`](https://github.com/MiSTer-devel/Main_MiSTer/blob/master/spi.cpp).

Source: [`user_io.h`](https://github.com/MiSTer-devel/Main_MiSTer/blob/master/user_io.h), [`hps_io.sv`](https://github.com/MiSTer-devel/Template_MiSTer/blob/master/sys/hps_io.sv)
...
For the complete CONF_STR specification, see [Configuration — CONF_STR](../09_configuration/conf_str.md).
