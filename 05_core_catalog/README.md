...
- [Framework](../02_framework/README.md) — shared sys/ modules all cores use
- [Extensions — RetroAchievements](../13_extensions/retroachievements.md) — per-core RA implementation status
