...
- [Framework — hps_io.sv](../06_fpga_subsystem/hps_io_module.md) — SD card and file I/O opcodes
- [Configuration — CONF_STR](../05_configuration/conf_str.md) — `S`, `F`, `FC`, `FS` slot declarations
