...
- [Configuration — MiSTer.ini](../09_configuration/mister_ini.md) — video mode, scaler, filter settings
- [Framework — sys_top.v](../02_framework/sys_top.md) — PLL tree, HDMI/VGA muxing
